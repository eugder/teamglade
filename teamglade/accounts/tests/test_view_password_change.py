...
class PasswordChangeTests(TestCase):
    def setUp(self):
        username = 'john'
        password = 'secret123'
        user = RoomUser.objects.create_user(username=username, email='john@doe.com', password=password)
...
class LoginRequiredPasswordChangeTests(TestCase):
    # Tries to access the password_change view without being logged in.
...
class PasswordChangeTestCase(TestCase):
    ...
    def setUp(self, data={}):
        self.user = RoomUser.objects.create_user(username='john', email='john@doe.com', password='old_password')
        self.url = reverse('password_change')
