...
class LoginInvitedViewTestCase(TestCase):
    ...
    #     self.url = reverse('login_invite', kwargs={'code': 'password'})
    #     self.response = self.client.get(self.url)

    # def setUp(self):
    #     email = 'john@doe.com'
    #     password = '123abcdef'
    #     RoomUser.objects.create_user(username=email, email=email, password=password)
    #     url = reverse('login_invite', kwargs={'code': password})
